...
- [x] **Step 3: 写入 MIT 许可证、公开 README 和内部案例边界说明**
...
- [x] **Step 1: 将设计规格拆成运行时入口、核心门禁和阶段规则**
